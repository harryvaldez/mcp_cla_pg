...
PORT = 55432
DB = "mcp_test"
DB_DSN = os.environ.get("TEST_NPX_DB_DSN") or os.environ.get("DATABASE_URL")


def _require_dsn() -> str:
    if not DB_DSN:
        raise RuntimeError("TEST_NPX_DB_DSN or DATABASE_URL must be set for test_npx_pg96.py")
    return DB_DSN
